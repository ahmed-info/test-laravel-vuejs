            ...
            <div class="col-md-12">
                <form>
                    <div class="form-group">
                        <label>Recipe</label>
                        <input type="text" class="form-control" v-model="product.recipe">
                    </div>
                    <div class="form-group">
                        <label>Ingredients</label>
                        <textarea type="text" rows="5" class="form-control" v-model="product.ingredients"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Directions</label>
                        <input type="number" class="form-control" v-model="product.directions">
                    </div>
